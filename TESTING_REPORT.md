...
- **Exact Fix**: Computed dynamic bounding boxes via `THREE.Box3` in Three.js and established calibrated scale constants (`markerScale`) in `src/data/watches.ts`.

### Challenge 2: In-Memory Material Mutation
...
### Challenge 3: WebXR Availability & Security Requirements
